...
public class Ch25Exersises
{
    public void removeLeaves( Object[] completeTree )
    {
        int i;
        int total = (Integer)completeTree[0];
        for (i = 1; i <= (Integer)completeTree[0]; i++)
        {
//            System.out.println("i: " + i + "  [i]: " + completeTree[i]);
            if (2 * i > completeTree.length - 1 && 2 * i + 1 > completeTree.length - 1|| completeTree[2 * i] == null && completeTree[2 * i + 1] == null)
            {
                break;
            }
        }
    ...
    public Object[] toArray( TreeNode root, int numNodes )
    {
        Object[] result = new Object[numNodes + 1];
        toArray(root, result, 1);
        return result;
    }
    ...
    public boolean isHeap( Integer[] items, int numNodes )
    {
        ...
        {
            if ((2 * i < items.length && items[i] > items[2 * i]) || 
                            (2 * i + 1 < items.length && items[i] > items[2 * i + 1]))
            {
                return false;
            }
        }
...
//        Object child2 = items[3];
        int minChild;
        if (items[c2] == null || items[c1] < items[c2])
        {
            minChild = c1;
        }
        else
        ...
        while (items[minChild] != null && minChild <= numNodes && items[minChild] < o)
        {
...
//            System.out.println("c1: " + items[c1]);
            ...
            if (c2 > numNodes || items[c1] < items[c2])
            {
                minChild = c1;
            }
            else
                                           ...
                                           PriorityQueue<Message> q2 )
    {
        ...
        Message m1 = q1.remove();
        Message m2 = q2.remove();
    ...
    public static void main( String[] args )
    {
        ...
        Ch25Exersises ex = new Ch25Exersises();
