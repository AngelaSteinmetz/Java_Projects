...
public class JMCh20Exercises<E>
{
    ...
    public int sizeFor( ListNode<E> head )
    {
        ...
        count = 1;
        for (ListNode<E> number = head; number.getNext() != null; number = number.getNext())
        {
            count++;
        }
    ...
    public ListNode<E> reverseList( ListNode<E> head )
    {
        ...
        ListNode<E> newLast = new ListNode<E> (head.getValue(), null);
        ListNode<E> node = newLast;
        ListNode<E> curNode = null;
        for (ListNode<E> cur = head.getNext(); cur != null; cur = cur.getNext())
        {
            curNode = new ListNode<E>(cur.getValue(), node);
            node = curNode;
        }
    ...
    public ListNode<String> concatenateStrings( ListNode<String> head )
    {
        ...
        ListNode<String> now = newHead;
        for (ListNode<String> cur = head.getNext(); cur != null; cur = cur.getNext())
        {          
            ListNode<String> newN = new 
                            ListNode<String>(now.getValue() + cur.getValue(), null);
            now.setNext( newN );
            now = newN;
        }
    ...
    public ListNode<String> insertInOrder( ListNode<String> head, String s )
    {
        ...
        else
        {
            ...
            if (s.compareTo( head.getValue() ) < 0)
            {
                ListNode<String> node = new ListNode<String>(s, head);
                head = node;
            }
            else
            {
                while (cur.getNext() != null && s.compareTo( cur.getNext().getValue() ) > 0)
                {
                    cur = cur.getNext();
                }
                if (cur.getNext() == null)
                ...
                else if (cur.getNext().getValue() != s)
                {
                    ListNode<String> node = new ListNode<String>(s, cur.getNext());
                    cur.setNext( node );
                }  
            }            
        }
...
//            System.out.println( node.getValue() );
    ...
    {
       for (ListNode<String> i = head; i != null; i = i.getNext())
       {
           ListNode<String> max = i;
           for (ListNode<String> j = i; j != null; j = j.getNext())
           {
               if (max.getValue().compareTo( j.getValue() ) > 0)
               {
                   max = j;
               }
           }
              
           String temp = max.getValue();
    ...
    public static ListNode2<Integer> removeMax( ListNode2<Integer> head )
    {
        ...
        ListNode2<Integer> answer = head;
        while (node != null)
        {
            if (node.getValue() > answer.getValue())
            {
                answer = node;
            }
            node = node.getNext();
        ...
        else if (answer.getNext() == null)
        {
            answer.getPrevious().setNext( null );
        }
        else
        {
            answer.getPrevious().setNext(answer.getNext() );
        }
