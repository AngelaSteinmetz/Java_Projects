...
public class JMCh12Exercises
{
    ...
    {
        char[] random = {'r', 'r', 'r', 'p', 'p', 'p', 'p', 'p', 's',
            's', 's', 's', 's', 's' };
        
        char ran = random[(int)(Math.random() * random.length)];
        return ran;
    }
    ...
    public String whatDoesMysteryCountCount()
    {
        ...
        String answer = mCount + "it counts the number of zeros in a row "
            + "at the beginning"; 
...
//        System.out.println(word);
        for (int i = 0; i < 26; i++)
        {
            int index = word.indexOf( alphabet.charAt( i ));
...
//                System.out.println(index);
                ...
                index = word.indexOf( alphabet.charAt(i), index + 1);
            }
        }
    ...
    // 12-11a, b, c, d, e
    // Mark true or false and explain:
    //   (a) An ArrayList can contain multiple references to the same object. TRUE         
    //   (b) The same object may belong to two different ArrayLists.  TRUE        
    //   (c) ArrayList's remove method destroys the object after it has
    //       been removed from the list.  FALSE         
    //   (d) ArrayList's add method makes a copy of the object and adds
    //       it to the list.    FALSE       
    //   (e) Two variables can refer to the same ArrayList. TRUE
    ...
    public void removeMin( ArrayList<Integer> list )
    {
        ...
        for (int i = 1; i < list.size(); i++)
        {
            ...
            if (number.compareTo( list.get( indexof ) ) < 0)
            {
                indexof = i;
            }
        }
    ...
    public static double averageTopTwo( int[] scores )
    {
        ...
        return (scores[iMax2] + scores[iMax1]) / 2;
    }
